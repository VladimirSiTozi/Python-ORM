...
from main_app.choises import LaptopBrands, OSChoices, MealTypeChoice, DungeonDifficultyChoices, WorkoutTypeChoices
...
class Dungeon(models.Model):
    ...
    difficulty = models.CharField(
        max_length=10,
        choices=DungeonDifficultyChoices.choices
    )
